...
Llama Index has many use cases (semantic search, summarization, etc.) that are [well documented](/docs/end_to_end_tutorials/use_cases.md). However, this doesn't mean we can't apply Llama Index to very specific use cases!
