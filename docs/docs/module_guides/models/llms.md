...
| [phi-3-mini-4k-instruct](https://github.com/run-llama/llama_index/tree/main/docs/docs/examples/benchmakrs/phi-3-mini-4k-instruct.ipynb) (microsoft)          | ✅                  | 🛑                  | ✅                       | ✅      | 🛑                | 🛑          | phi-3-mini-4k-instruct does well on basic RAG, text-to-SQL and Query planning tasks. It struggles with routing, Pydantic Programs and Agentic tasks.                                                  |
