...
node1 = Node(text="<text_chunk>", id_="<node_id>")
node2 = Node(text="<text_chunk>", id_="<node_id>")
# set relationships
node1.relationships[DocumentRelationship.NEXT] = node2.node_id
node2.relationships[DocumentRelationship.PREVIOUS] = node1.node_id
nodes = [node1, node2]
```
