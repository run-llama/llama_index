...
| [Microsoft-phi-2](https://colab.research.google.com/drive/1__nHBLu7yFNWMo5_T-SpkPW9KgTxxrfY?usp=sharing) (huggingface)               | ✅                  | 🛑                  | 🛑                       | ✅       | 🛑                | ✅          | phi-2 as a small LLM does surprisingly well on agent and text-to-SQL tasks. It struggles a bit with routing, subQuestion and Pydantic tasks.                                        |
