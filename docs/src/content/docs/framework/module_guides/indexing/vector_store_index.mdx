...
By default, VectorStoreIndex stores everything in memory. See [Storing the vector index](#storing-the-vector-index) below for more on how to use persistent vector stores.
