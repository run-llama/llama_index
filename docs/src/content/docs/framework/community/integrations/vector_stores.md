...
- [Azure Cosmos DB Mongo vCore](/python/framework/integrations/vector_stores/azurecosmosdbmongodbvcoredemo)
- [Azure Cosmos DB NoSQL](/python/framework/integrations/vector_stores/azurecosmosdbnosqldemo)
