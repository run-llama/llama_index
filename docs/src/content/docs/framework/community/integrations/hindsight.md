...
Hindsight runs locally via Docker, pip, or embedded in Python, or you can use [Hindsight Cloud](https://hindsight.vectorize.io). See the [quick start guide](https://github.com/vectorize-io/hindsight#quick-start) for setup instructions.
