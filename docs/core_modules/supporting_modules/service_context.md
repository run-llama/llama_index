...
- [LLM](/docs/core_modules/model_modules/llms/usage_custom.md)
- [Embedding Model](/docs/core_modules/model_modules/embeddings/usage_pattern.md)
- [Node Parser](/docs/core_modules/data_modules/node_parsers/usage_pattern.md)
