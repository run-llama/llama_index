        ...
        for k, example in enumerate(data):
            ...
            while round_count < 5 and not feedback_answer == 'end':
                ...
                if not 'Unsolved Query' in feedback:
                    new_prompt = \
                    """Reference: {} According to this Reference, the answer for "{}" should be "{}", you can change your answer based on the Reference and continue constructing the reasoning chain to give the final answer for [Question]:{}""".format(feedback_list[0],feedback_list[1],q,feedback_list[2])
                else:
                    new_prompt = \
                    """Reference: {} According to this Reference, the answer for "{}" should be "{}", you can give your answer based on the Reference and continue constructing the reasoning chain to give the final answer for [Question]：{} """.format(feedback_list[0],feedback_list[1],q,feedback_list[2])
