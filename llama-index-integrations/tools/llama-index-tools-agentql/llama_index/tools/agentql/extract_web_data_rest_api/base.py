...
class ExtractWebDataRestAPISpec(BaseToolSpec):
    """
    Extract web data from a REST API.
    """
    ...
    def __init__(
        ...
        """
        Initialize ExtractWebDataRestAPI.

        Args:
            api_key: AgentQL API key. You can create one at https://dev.agentql.com.
            api_timeout: The number of seconds to wait for a request before timing out. Defaults to 900.
            ...
            wait_for_page_load: The number of seconds to wait for the page to load before extracting data. Defaults to 0.
