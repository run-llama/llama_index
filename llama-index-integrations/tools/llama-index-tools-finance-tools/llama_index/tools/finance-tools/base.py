...
class FinanceAgentToolSpec(BaseToolSpec):
    ...
    def __init__(self, polygon_api_key: str, finnhub_api_key: str, alpha_vantage_api_key: str, newsapi_api_key: str):
        self._api_key = {
    ...
    def get_stocks_with_upcoming_earnings(self, num_days_from_now: int, only_sp500: bool) -> pd.DataFrame:
        ...
        return earnings.get_upcoming_earnings(self._api_key, start_date=start_date, end_date=end_date, country='USD', only_sp500=only_sp500)
    ...
    def get_current_stock_price_info(self, stock_ticker_symbol: str) -> Optional[Dict[str, Any]]:
        ...
        """
        price_info = news.get_current_stock_price_info(self._api_key, stock_ticker_symbol)
