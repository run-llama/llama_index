...
def get_earnings_history(api_key: Dict[str, str], symbol: str) -> pd.DataFrame:
    ...
    response = requests.request("GET", f'https://www.alphavantage.co/query?function=EARNINGS&symbol={symbol}&apikey={ALPHA_VANTAGE_API_KEY}')
...
def get_upcoming_earnings(api_key: Dict[str, str], start_date: str, end_date: str, country: str, only_sp500: bool):
