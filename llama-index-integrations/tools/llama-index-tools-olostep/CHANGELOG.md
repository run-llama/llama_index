CHANGELOG for llama-index-tools-olostep
...
- `search_web()` - Search the web and return relevant links
- `answer_question()` - Get AI-synthesized answers with verified sources
