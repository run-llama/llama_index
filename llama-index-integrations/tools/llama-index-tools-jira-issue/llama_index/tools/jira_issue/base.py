...
class JiraIssueToolSpec(BaseToolSpec):
    ...
    def get_all_projects(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "error": True,
                "message": f"Failed to fetch projects from JIRA: {str(e)}",
            }
    ...
    def create_issue(
            ...
            issue_type: Literal["Task", "Bug",
                                "Epic"] = "Task") -> Dict[str, Any]:
        ...
        """
        try:
            new_issue = self.jira.create_issue(project=project_key,
                                               summary=summary,
            ...
            return {
                "error": True,
                "message": f"Failed to create new issue: {str(e)}",
            }

    def add_comment_to_issue(self, issue_key: str,
        ...
        try:
            ...
            return {
                "error":
                    True,
                "message":
                    f"Failed to add comment to issue {issue_key}: {str(e)}",
            }
    ...
    def update_issue_summary(self,
        ...
        try:
            ...
            return {
                "error": False,
                "message": f"Issue {issue_key} summary updated."
            }
        except Exception as e:
            return {
                "error": True,
        ...
        try:
            ...
            if not target_user:
                return {
                    "error":
                        True,
                    "message":
                        f"User with full name '{assignee_full_name}' not found"
                }
            ...
            return {
                "error":
                    False,
                "message":
                    f"Issue {issue_key} successfully assigned to {assignee_full_name}"
            }
        except Exception as e:
            return {
                "error":
                    True,
                "message":
                    f"An error occurred while updating the assignee: {str(e)}"
            }

    def update_issue_status(
            self, issue_key: str,
            new_status: Literal["To Do", "In Progress",
                                "Done"]) -> Dict[str, Any]:
            ...
            if transition_id:
                ...
                return {
                    "error":
                        False,
                    "message":
                        f"Issue {issue_key} status updated to {new_status}."
                }
            else:
                ...
                return {
                    "error":
                        True,
                    "message":
                        f"Status '{new_status}' not available for issue {issue_key}. Available transitions: {available_statuses}",
                }
        except Exception as e:
            return {
                "error":
                    True,
                "message":
                    f"Failed to update status for issue {issue_key}: {str(e)}",
            }

    def update_issue_due_date(self,
                              issue_key: str,
        ...
        try:
            ...
            return {
                "error":
                    False,
                "message":
                    f"Issue {issue_key} due date {'updated' if due_date else 'cleared'}."
            }
        except Exception as e:
            return {
                "error":
                    True,
                "message":
                    f"Failed to update due date for issue {issue_key}: {str(e)}"
            }
    ...
    def delete_issue(self, issue_key: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "error": True,
                "message": f"Failed to delete issue {issue_key}: {str(e)}",
            }
