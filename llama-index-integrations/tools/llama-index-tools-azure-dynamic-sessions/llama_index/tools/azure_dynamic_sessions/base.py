...
class AzureDynamicSessionsToolSpec(BaseToolSpec):
    ...
    def __init__(
        ...
        def _access_token_provider_factory(self) -> Callable[[], Optional[str]]:
            ...
            def access_token_provider(self) -> Optional[str]:
                ...
                if self.access_token is None or datetime.fromtimestamp(self.access_token.expires_on, timezone.utc) < (datetime.now(timezone.utc) + timedelta(minutes=5)):
                    ...
                    self.access_token = credential.get_token("https://dynamicsessions.io/.default")
        ...
        try:
            _package_version = importlib.metadata.version("llamaindex-azure-dynamic-sessions")
        except importlib.metadata.PackageNotFoundError:
            _package_version = "0.0.0"
        self.user_agent = f"llamaindex-azure-dynamic-sessions/{_package_version} (Language=Python)"
