...
class AzureDynamicSessionsToolSpec(BaseToolSpec):
    ...
    def __init__(
        ...
        self.access_token_provider: Callable[
            [], Optional[str]
        ] = _access_token_provider_factory(self)
        ...
        try:
            _package_version = importlib.metadata.version(
                "llamaindex-azure-dynamic-sessions"
            )
        except importlib.metadata.PackageNotFoundError:
            _package_version = "0.0.0"

        self.user_agent = (
            f"llamaindex-azure-dynamic-sessions/{_package_version} (Language=Python)"
        )
    ...
    def upload_file(
        self, data=None, remote_file_path: str = None, local_file_path: str = None
