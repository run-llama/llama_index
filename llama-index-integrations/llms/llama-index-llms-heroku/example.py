...
def main():
    ...
    if not os.getenv("INFERENCE_KEY") or not os.getenv("INFERENCE_URL") or not os.getenv("INFERENCE_MODEL_ID"):
        print("Environment variables not set. Using placeholder values for demonstration.")
    ...
    try:
        ...
        response = llm.complete("Explain the importance of open source LLMs in one sentence.")
