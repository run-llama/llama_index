...
class KeywordsAI(OpenAI):
    ...
    def _tokenizer(self) -> Optional[Tokenizer]:
        ...
        KeywordsAI can do this using the tiktoken package, subclasses may not have
        this convenience.
        """
    ...
    def _get_response_token_counts(self, raw_response: Any) -> dict:
        ...
        if hasattr(raw_response, "usage"):
            ...
            # NOTE: other model providers that use the KeywordsAI client may not report usage
            if usage is None:
                return {}
    ...
    def get_tool_calls_from_response(
        ...
        **kwargs: Any,
        ...
        for tool_call in tool_calls:
            if not isinstance(tool_call, get_args(KeywordsAIToolCall)):
                raise ValueError("Invalid tool_call object")
            if tool_call.type != "function":
                raise ValueError("Invalid tool type. Unsupported by KeywordsAI")
