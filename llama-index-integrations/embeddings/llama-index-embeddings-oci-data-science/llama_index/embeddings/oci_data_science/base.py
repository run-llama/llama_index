...
class OCIDataScienceEmbedding(BaseEmbedding):
    ...
    **Setup:**
    ...
    [OCI Authentication Guide](https://accelerated-data-science.readthedocs.io/en/latest/user_guide/cli/authentication.html)

    Ensure you have the required policies to access the OCI Data Science Model
    Deployment endpoint. See:
    ...
    [Deploying LLM Models](https://docs.oracle.com/en-us/iaas/data-science/using/ai-quick-actions-model-deploy.htm)
    ...
    **Asynchronous Usage:**
    ...
    model_name : Optional[str], optional
        The name of the OCI Data Science embedding model to use. Defaults to `"odsc-embeddings"`.
    auth : Dict[str, Any], optional
        The authentication dictionary used for OCI API requests. If not provided,
        it will be autogenerated based on the environment variables. For more details,
        see [OCI Authentication Guide](https://accelerated-data-science.readthedocs.io/en/latest/user_guide/cli/authentication.html).
        Defaults to an empty dictionary.
    timeout : Optional[float], optional
        The timeout setting for the HTTP request in seconds. Defaults to `120`.
    max_retries : Optional[int], optional
        The maximum number of retry attempts for the request. Defaults to `5`.
    embed_batch_size : int, optional
        The batch size for embedding calls. Must be greater than `0` and less than or equal to `2048`.
        Defaults to `DEFAULT_EMBED_BATCH_SIZE`.
    additional_kwargs : Optional[Dict[str, Any]], optional
        Additional keyword arguments for the OCI Data Science AI request. Defaults to an empty dictionary.
    default_headers : Optional[Dict[str, str]], optional
        The default headers for API requests. Defaults to an empty dictionary.
    callback_manager : Optional[CallbackManager], optional
        A callback manager for handling events during embedding operations. Defaults to `None`.
    **kwargs : Any
    ...
    model_name : str
        The name of the OCI Data Science embedding model.
    embed_batch_size : int
        The batch size for embedding calls.
    additional_kwargs : Dict[str, Any]
        Additional keyword arguments for the OCI Data Science AI request.
    ...
    -------
    client
        Returns the synchronous client instance.
    async_client
    ...
    auth: Union[Dict[str, Any], None] = Field(
        ...
        description=(
            ...
            "For more details, see the OCI Authentication Guide."
        ),
    )
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        model_name : Optional[str], optional
            The name of the OCI Data Science embedding model to use. Defaults to `"odsc-embeddings"`.
        auth : Optional[Dict[str, Any]], optional
            The authentication dictionary used for OCI API requests. Defaults to `None`.
        timeout : Optional[float], optional
            The timeout setting for the HTTP request in seconds. Defaults to `120`.
        max_retries : Optional[int], optional
            The maximum number of retry attempts for the request. Defaults to `5`.
        embed_batch_size : int, optional
            The batch size for embedding calls. Defaults to `DEFAULT_EMBED_BATCH_SIZE`.
        additional_kwargs : Optional[Dict[str, Any]], optional
            Additional keyword arguments for the OCI Data Science AI request. Defaults to `None`.
        default_headers : Optional[Dict[str, str]], optional
            The default headers for API requests. Defaults to `None`.
        callback_manager : Optional[CallbackManager], optional
            A callback manager for handling events during embedding operations. Defaults to `None`.
        **kwargs : Any
            Additional keyword arguments.
    ...
    def validate_env(cls, values: Dict[str, Any]) -> Dict[str, Any]:
        ...
        This method checks that all required dependencies are installed and
    ...
    def _get_query_embedding(self, query: str) -> List[float]:
        ...
        ----------
        query : str
            The query string for which to generate an embedding.
