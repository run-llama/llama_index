...
class TestInstructionFunctionality:
    ...
    def test_format_text_with_instruction(self):
        ...
        expected = "Represent the document for retrieval: AI is a field of computer science"
        assert result == expected
