...
Curabitur arcu erat, accumsan id imperdiet et, porttitor at sem.
    """
    expected_tups = [('Main Title (Level 1) Section 1: Introduction (Level 2) Subsection 1.1: Background (Level 3)', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus lacinia arcu eget nulla fermentum, et suscipit justo volutpat.'),
                     ('Main Title (Level 1) Section 1: Introduction (Level 2) Subsection 1.2: Objective (Level 3)', 'Curabitur non nulla sit amet nisl tempus convallis quis ac lectus. Integer posuere erat a ante venenatis dapibus posuere velit aliquet.'),
                     ('Main Title (Level 1) Section 2: Methodology (Level 2) Subsection 2.1: Approach (Level 3)', 'Mauris blandit aliquet elit, eget tincidunt nibh pulvinar a. Pellentesque in ipsum id orci porta dapibus.'),
                     ('Main Title (Level 1) Section 2: Methodology (Level 2) Subsection 2.2: Tools and Techniques (Level 3) Sub-subsection 2.2.1: Tool 1 (Level 4)',
                      'Donec rutrum congue leo eget malesuada. Vivamus suscipit tortor eget felis porttitor volutpat.\nDonec sollicitudin molestie malesuada.'),
                     ('Main Title (Level 1) Section 2: Methodology (Level 2) Subsection 2.2: Tools and Techniques (Level 3) Sub-subsection 2.2.2: Tool 2 (Level 4)', 'Proin eget tortor risus. Cras ultricies ligula sed magna dictum porta.'),
                     ('Main Title (Level 1) Section 3: Results (Level 2) Subsection 3.1: Data Analysis (Level 3)', 'Sed porttitor lectus nibh. Donec rutrum congue leo eget malesuada.'),
                     ('Main Title (Level 1) Section 3: Results (Level 2) Subsection 3.2: Findings (Level 3)', 'Curabitur arcu erat, accumsan id imperdiet et, porttitor at sem.')]
