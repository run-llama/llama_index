...
def test_tzafon_web_reader_load_data(mock_tzafon: MagicMock, mock_playwright: MagicMock) -> None:
    from llama_index.readers.web import TzafonWebReader
    ...
    mock_playwright.sync_api.sync_playwright = sync_playwright_mock
    
    mock_playwright_context = sync_playwright_mock.return_value.__enter__.return_value
