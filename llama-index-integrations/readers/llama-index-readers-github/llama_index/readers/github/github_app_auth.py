...
if __name__ == "__main__":
    ...
    async def test_github_app_auth() -> None:
        """Test GitHub App authentication."""
        # This is just example code - requires valid credentials
        print("GitHub App Authentication Test")
        print("Note: This requires valid GitHub App credentials")
        ...
        #
        #     # Force refresh
        #     token3 = await auth.get_installation_token(force_refresh=True)
        #     print(f"Refreshed token: {token3[:20]}...")
        # except GitHubAppAuthenticationError as e:
        #     print(f"Authentication error: {e}")

    asyncio.run(test_github_app_auth())
