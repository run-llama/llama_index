...
from llama_index.readers.github.repository.event import GitHubFileProcessedEvent
...
COMMIT_JSON = '{"sha":"test_commit_sha","url":"...","commit":{"tree":{"sha":"test_tree_sha"}}}'
...
def mock_client(monkeypatch):
    ...
    async def mock_get_blob(self, *args, **kwargs):
        from llama_index.readers.github.repository.github_client import GitBlobResponseModel
