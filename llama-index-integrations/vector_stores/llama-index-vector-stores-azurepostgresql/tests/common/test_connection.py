"""Connection handling tests for Azure Database for PostgreSQL."""
...
from llama_index.vector_stores.azure_postgres.common.aio import (
...
class TestCheckConnection:
    ...
    async def test_async_it_works(self, async_connection: AsyncConnection) -> None:
        """Ensure ``async_check_connection`` returns None on a healthy connection."""
