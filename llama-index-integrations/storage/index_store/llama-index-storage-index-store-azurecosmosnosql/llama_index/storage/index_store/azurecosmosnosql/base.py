...
class AzureCosmosNoSqlIndexStore(KVIndexStore):
    ...
    def from_connection_string(
        ...
        azure_cosmos_nosql_kvstore = AzureCosmosNoSqlKVStore.from_connection_string(
            connection_string, index_db_name, index_container_name, cosmos_container_properties, cosmos_database_properties
        )
    ...
    def from_account_and_key(
        ...
        azure_cosmos_nosql_kvstore = AzureCosmosNoSqlKVStore.from_account_and_key(
            endpoint, key, index_db_name, index_container_name, cosmos_container_properties,
    ...
    def from_aad_token(
        ...
        azure_cosmos_nosql_kvstore = AzureCosmosNoSqlKVStore.from_aad_token(
            endpoint, index_db_name, index_container_name, cosmos_container_properties, cosmos_database_properties
        )
        namespace = index_db_name + "." + index_container_name
        return cls(
            azure_cosmos_nosql_kvstore,
