...
class AzureCosmosMongoVCoreIndexStore(KVIndexStore):
    ...
    def __init__(
        ...
        super().__init__(azure_cosmos_mongo_vcore_kvstore, namespace=namespace, collection_suffix=collection_suffix)
    ...
    def from_connection_string(
        ...
        azure_cosmos_mongo_vcore_kvstore = AzureCosmosMongoVCoreKVStore.from_connection_string(
    ...
    def from_host_and_port(
        ...
        azure_cosmos_mongo_vcore_kvstore = AzureCosmosMongoVCoreKVStore.from_host_and_port(
