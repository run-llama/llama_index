...
class UpstashChatStore(BaseChatStore):
	...
	def __init__(
		...
		try:
			...
			logger.error("Upstash Redis client could not be initiated")
	...
	def get_keys(self) -> List[str]:
		"""Get all keys."""
		return self.redis_client.keys(f"*")

	def _insert_element_at_index(self, key: str,  message: ChatMessage, idx: int) -> List[ChatMessage]:
