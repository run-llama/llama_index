...
from llama_index.ingestion.pipeline import get_transformation_hash
from llama_index.schema import BaseNode, TextNode, TransformComponent
...
def test_cache():
    ...
    assert cache.get(hash)[0].get_content() == new_nodes[0].get_content()
