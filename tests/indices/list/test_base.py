...
def test_query(
    ...
    node_info = (
        response.source_nodes[0].node.node_info if response.source_nodes[0].node.node_info else {}
    )
...
def test_index_overlap(
    ...
    node_info_1 = (
        response.source_nodes[1].node.node_info if response.source_nodes[1].node.node_info else {}
    )
