    ...
    df = pd.DataFrame(
        {
            ...
            "description":["""Toronto, Canada's largest city, is a vibrant and diverse metropolis situated in the province of Ontario. 
...
With its welcoming atmosphere, top-notch education, and multicultural charm, Toronto is a global destination for both tourists and professionals alike."""
    ...
    query_engine = PandasQueryEngine(
        df, service_context=mock_service_context, verbose=True, output_kwargs={'max_colwidth': 90}
    )
