...
def test_upsert_triplet(nebula_graph_store):
    ...
    nebula_graph_store.upsert_triplet("subject_placeholder", "relation_placeholder", "object_placeholder")
    result = nebula_graph_store.get("subject_placeholder")
    assert result
...
def test_delete(nebula_graph_store):
    ...
    nebula_graph_store.upsert_triplet("subject_placeholder", "relation_placeholder", "object_placeholder")
    nebula_graph_store.delete("subject_placeholder", "relation_placeholder", "object_placeholder")
    result = nebula_graph_store.get("subject_placeholder")
    assert not result
