...
class KGTableRetriever(BaseRetriever):
    ...
    Args:
        ...
        include_text (bool): Use the document text source from each relevant triplet
            during queries.
        embedding_mode (KGRetrieverMode): Specifies whether to use keyowrds,
    ...
    def __init__(
        ...
        embedding_mode: Optional[KGRetrieverMode] = KGRetrieverMode.KEYWORD,
        ...
        **kwargs: Any,
        ...
        self._embedding_mode = KGRetrieverMode(embedding_mode)
    ...
    def _retrieve(
        ...
        if self._embedding_mode != KGRetrieverMode.EMBEDDING:
        ...
        if (
            self._embedding_mode != KGRetrieverMode.KEYWORD
        ...
        if self._embedding_mode == KGRetrieverMode.HYBRID:
