...
from gpt_index.indices.response_utils.response import give_response, refine_response
...
class GPTKeywordTableIndex(BaseGPTIndex[KeywordTable]):
    ...
    def _mode_to_query(
        ...
        if mode == DEFAULT_MODE:
            ...
            query = GPTKeywordTableIndexFreqQuery(mode, **query_kwargs)
        else:
    ...
    # def query(self, query_str: str, verbose: bool = False, mode: str = DEFAULT_MODE) -> str:
    #     """Answer a query."""
