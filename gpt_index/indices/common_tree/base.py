...
class GPTTreeIndexBuilder:
    ...
    def build_index_from_nodes(
        ...
        event_id = self._service_context.callback_manager.on_event_start(CBEvent(CBEventType.TREE, payload={"chunks": text_chunks}))
        ...
        self._service_context.callback_manager.on_event_end(CBEvent(CBEventType.TREE, payload={"summaries": summaries, "level": level}), event_id=event_id)
