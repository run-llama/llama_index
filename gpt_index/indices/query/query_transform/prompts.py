...
DEFAULT_STEP_DECOMPOSE_QUERY_TRANSFORM_TMPL = (
    ...
    "Given the context and previous reasoning, return the next question that can "
    "be answered from "
    "the context. The next question can be the same as the original question, "
    "or the next question can represent a subcomponent of the overall question.\n"
    # "If the next question cannot be answered from the context, provide 'None' as the answer. "
    "As an example: "
    "\n\n"
    "Question: How many Grand Slam titles does the winner of the 2020 Australian "
    "Open have?\n"
