...
class Prompt:
    ...
    def __init__(self, template: str, langchain_prompt: Optional[LangchainPrompt] = None, **prompt_kwargs: Any) -> None:
        """Init params."""
    ...
    @classmethod
    def from_langchain_prompt(cls, prompt: LangchainPrompt, **kwargs: Any) -> PMT:
