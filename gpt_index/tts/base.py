...
class barkTTS:
    def __init__(self, text_temp: float = 0.7, waveform_temp: float = 0.7) -> None:
        """
        Args:
    ...
    def generate_bark_audio(
        ...
        history_prompt = lang_speaker_voice
        audio_chunks = []
        ...
        for chunk in chunks:
            with tempfile.TemporaryDirectory() as d:
                if full_generation:
                    ...
                    history_prompt = f
                full_generation, audio_array = self.generate_audio(
                    chunk,
