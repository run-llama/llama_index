...
from llama_index.ingestion.client.generated_client.types.configurable_transformation_definition import (
    ConfigurableTransformationDefinition,
)
from llama_index.ingestion.client.generated_client.types.data_sink_definition import (
    DataSinkDefinition,
)
from llama_index.ingestion.client.generated_client.types.data_source_definition import (
