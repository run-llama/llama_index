...
def resolve_konko_credentials(
    ...
    konko_api_key = get_from_param_or_env("konko_api_key", konko_api_key, "KONKO_API_KEY", "")
    openai_api_key = get_from_param_or_env("openai_api_key", openai_api_key, "OPENAI_API_KEY", "")
    ...
    konko_api_key = konko_api_key or konko.konko_api_key
    openai_api_key= openai_api_key or konko.openai_api_key
