...
from llama_index.llms.openai_utils import from_openai_message_dict, to_openai_message_dicts
...
class LlamaAPI(CustomLLM):
    ...
    def __init__(
        ...
        try:
            ...
            raise ImportError(
                "llama_api not installed." "Please install it with `pip install llamaapi`."
            ) from e
