...
class PsychicReader(BaseReader):
    ...
    This reader connects to an instance of Psychic and reads data from it, given a connector ID, 
    ...
    def __init__(self, psychic_key: str = None) -> None:
    ...
    def load_data(self, connector_id: str = None, account_id: str = None) -> List[Document]:
