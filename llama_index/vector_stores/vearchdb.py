        ...
        **kwargs: Any,
        ...
        if self.flag:
            ...
            if embeddings is not None and metadatas is not None:
                ...
                for text, metadata, embed ,id in zip(texts, metadatas, embeddings, ids):
                    ...
                    insert_res = self.vearch.insert_one(
                        self.using_db_name, self.using_table_name, profiles,id
                    )
