...
import openai
from tenacity import retry, stop_all, stop_after_delay, stop_after_attempt, wait_random_exponential
...
@retry(wait=wait_random_exponential(min=1, max=20), stop=stop_all(stop_after_attempt(6), stop_after_delay(60)))
def get_embedding(
