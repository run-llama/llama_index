...
class StorageContext:
    ...
    def to_dict(self) -> dict:
        all_simple = (
            isinstance(self.vector_store, SimpleVectorStore) and 
            isinstance(self.docstore, SimpleDocumentStore) and 
            isinstance(self.index_store, SimpleIndexStore)
        )
        if not all_simple:
            raise ValueError('to_dict only available when using simple doc/index/vector stores')
