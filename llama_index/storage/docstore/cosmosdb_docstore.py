...
class CosmosDBDocStore(KVDocumentStore):
    """CosmosDB Document (Node) store.

    A CosmosDB store for Document and Node objects.
    ...
    def __init__(
        ...
        self._metadata_collection = f"{self._namespace}_metadata"
