...
try:
    ...
    raise ImportError("Could not import redis")
...
def _redis_sentinel_client(redis_url: str, **kwargs: Any) -> Any:
    """
...
def _redis_cluster_client(redis_url: str, **kwargs: Any) -> Any:
    try:
...
class RedisChatStore(BaseChatStore):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        """Initialize."""
        super().__init__()
        self.redis_client = _get_client(redis_url, **kwargs)
        self.ttl = ttl
