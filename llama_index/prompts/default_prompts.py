...
DEFAULT_CUSTOM_QUERY_PROMPT_TMPL = (
    "Context information is below.\n"
    "---------------------\n"
    "{context_str}\n"
    "---------------------\n"
    "{system_prompt}{query_str}{post_query_prompt}\n"
)
DEFAULT_CUSTOM_QUERY_PROMPT = Prompt(
    DEFAULT_CUSTOM_QUERY_PROMPT_TMPL, prompt_type=PromptType.CUSTOM
)


DEFAULT_CUSTOM_REFINE_PROMPT_TMPL = (
    "The original question is as follows: {query_str}{post_query_prompt}\n"
    "We have provided an existing answer: {existing_answer}\n"
    "We have the opportunity to refine the existing answer "
    "(only if needed) with some more context below.\n"
    "------------\n"
...
DEFAULT_CUSTOM_REFINE_PROMPT = Prompt(
    DEFAULT_CUSTOM_REFINE_PROMPT_TMPL, prompt_type=PromptType.CUSTOM
)
