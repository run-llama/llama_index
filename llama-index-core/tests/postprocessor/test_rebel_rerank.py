...
def mock_rebel_predict(
    self: Any, prompt: BasePromptTemplate, **prompt_args: Any
) -> str:
    """Patch llm predictor predict."""
    # If this is the meta_prompt call (first call), just return a template
...
def test_rebel_rerank() -> None:
    ...
    query_str = "What is?"
    result_nodes = rebel_rerank.postprocess_nodes(
