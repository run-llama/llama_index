...
class AsyncBaseTool(BaseTool):
    ...
    async def acall_stream(
        ...
        For tools backed by async generators, each yielded value becomes a
        ToolOutput with ``is_preliminary=True`` except for the last one.

        The default implementation falls back to ``acall`` and yields one
        final ToolOutput.
        """
