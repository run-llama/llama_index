...
class MultimodalSimpleSummarize(BaseMultimodalSynthesizer):
    def __init__(
        self,
        llm: Optional[LLM] = None,
        callback_manager: Optional[CallbackManager] = None,
    ...
    def _get_prompts(self) -> PromptDictType:
        """Get prompts."""
        return {"chat_content_qa_template": self._chat_content_qa_template}
    ...
    async def aget_response(  # type: ignore[override]
        self,
        query_str: str,
        text_chunks: Optional[Sequence[str]] = None,
        message_chunks: Optional[Sequence[ChatMessage]] = None,
        **response_kwargs: Any,
    ) -> RESPONSE_TEXT_TYPE:
