...
class DocumentSummaryIndex(BaseIndex[IndexDocumentSummary]):
    ...
    Args:
        ...
        embed_summaries (bool): Whether to embed the summaries.
            ...
            Defaults to True.
        store_nodes_override (bool): Whether to store nodes in the docstore.
            In database-backed storage contexts (like PostgreSQL/pgvector), 
            setting this to True ensures that the source nodes are persisted 
            alongside the summaries, avoiding KeyErrors during retrieval.
            Defaults to False.
    ...
    def build_index_from_nodes(
        ...
        **insert_kwargs: Any,
        ...
        NOTE: Overrides BaseIndex.build_index_from_nodes.
            DocumentSummaryIndex only stores nodes in document store
            if store_nodes_override is True.
        """
        if self._store_nodes_override:
