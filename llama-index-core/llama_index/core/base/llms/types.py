...
class ChatMessage(BaseModel):
    ...
    Attributes:
        role (MessageRole): The role of the message (e.g., USER, ASSISTANT, SYSTEM).
        additional_kwargs (dict): Additional keyword arguments.
        blocks (list[ContentBlock]): The content blocks of the message.
            This is the modern way to represent multi-modal content.
            See `ContentBlock` for available block types (Text, Image, Audio, etc.).
    """
    ...
    def content(self) -> str | None:
        ...
        Returns:
            ...
            If multiple TextBlocks exist, they are joined with newlines.
        """
        content_strs = []
