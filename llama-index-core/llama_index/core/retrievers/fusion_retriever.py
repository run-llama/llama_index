        ...
        for nodes_with_scores in results.values():
            for node_with_score in nodes_with_scores:
                ...
                if text in all_nodes:
                    existing_score = all_nodes[text].score or 0.0
                    new_score = node_with_score.score or 0.0
                    all_nodes[text].score = existing_score + new_score
                else:
    ...
    def _simple_fusion(
        ...
        for nodes_with_scores in results.values():
            for node_with_score in nodes_with_scores:
                ...
                if text in all_nodes:
                    max_score = max(
                        node_with_score.score or 0.0, all_nodes[text].score or 0.0
                    )
