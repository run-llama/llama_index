...
def run_async_tasks(
    ...
    if show_progress:
        ...
        # is not supported
            ...
            # Only the tqdm setup above is optional. Exceptions raised by the
            # tasks themselves must propagate: the coroutines are consumed by
            # this point, so falling through to the plain path would re-await
            # them and mask the real failure behind an unrelated
