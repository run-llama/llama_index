from llama_index.legacy.legacy.question_gen.llm_generators import LLMQuestionGenerator
from llama_index.legacy.legacy.question_gen.types import SubQuestion
